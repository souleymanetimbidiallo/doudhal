                        ...
                        <div class="p-3">
                            ...
                            <form action="" method="POST" class="user">
                                <div class="form-group">
                                    <label for="login" class="h6 text-gray-900">Nom d'utilisateur 
                                ...
                                <div class="form-group d-flex justify-content-between">
                                    ...
                                    <p><a class="small" href="forgot-password.html">Mot de passe oublié?</a></p>
                                </div>
                            ...
                            <hr> 
                            <div class="text-center">
                                <p>Pas de compte ? <a class=""href="index.php?p=register">Créer un compte</a></p>
                            </div>
                        </div>
                    </div>
                </div>
...
$(document).ready(function(){
    $("#submit").click(function(e){
        e.preventDefault();
        $.post(
            '../pages/users/login-db.php', //Le fichier contrôlant la connexion
            {
